...
def unet(input_size=(256,256,3)):
    ...
    up6 = keras.layers.Conv2DTranspose(512, (2, 2), stride=(2,2), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(drop5)
    ...
    up7 = keras.layers.Conv2DTranspose(256, (2, 2), stride=(2,2), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
    ...
    up8 = keras.layers.Conv2DTranspose(128, (2, 2), stride=(2,2), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv7)
    ...
    up9 = keras.layers.Conv2DTranspose(64, (2, 2), stride=(2, 2), activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv8)
    ...
    conv10 = keras.layers.Conv2D(1, 1, activation = 'softmax', dtype=tf.float32)(conv9)
